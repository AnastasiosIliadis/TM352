      ...
      function updateMap(address) {
        var onSuccess = function(position) {
          ...
          if (address != undefined) {
			...
			///plugin area start///
			nativegeocoder.forwardGeocode(success, failure, get_name_value("addr"), { useLocale: true, maxResults: 1 });
			function success(coordinates) {
			  var firstResult = coordinates[0];
			  alert("The coordinates are latitude = " + firstResult.latitude + " and longitude = " + firstResult.longitude + " Area: " + get_name_value("addr") );
			  map.setCenter({lng:firstResult.longitude, lat:firstResult.latitude});
			}
